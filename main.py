...
def list_files():
    """
        http://127.0.0.1:8080/list_files?bucket_name=comp4312_a2_0666558
    """
    try:
        bucket_name = request.args.get('bucket_name', default='comp4312_a2_0666558', type=str)
        file_names = []
        #####################
        # Your code is here #
...
def create_bk():
    """
        http://127.0.0.1:8080/create_bk?bucket_name=comp4312_assignment2_0666558
    """
    try:
        bucket_name = "comp4312_a2_0666558"
        #####################
        # Your code is here #
        ####################
...
def delete_bk():
    """
        http://127.0.0.1:8080/delete_bk?bucket_name=comp4312_assignment2_066658
    """
    try:
        bucket_name = "comp4312_a2_0666558"
        #####################
